...
#include "./dde-session/toolGenerate/qdbusxml2cpp/org.freedesktop.DBusAdaptor.h"
...
QStringList DBusAdaptor::features() const
{
    // get the value of property Features
    return qvariant_cast< QStringList >(parent()->property("Features"));
}

QStringList DBusAdaptor::interfaces() const
{
...
void DBusAdaptor::UpdateActivationEnvironment(EnvInfoList in0)
{
    // handle method call org.freedesktop.DBus.UpdateActivationEnvironment
    QMetaObject::invokeMethod(parent(), "UpdateActivationEnvironment", Q_ARG(EnvInfoList, in0));
}
